...
module.exports = {
    ...
    async handleStats(embed) {
        ...
        embed.addFields({
            ...
            value: `**Heap Used:** ${memStats.heapUsed}MB / ${memStats.heapTotal}MB\n` +
        ...
        embed.addFields({
            name: '💾 Cache Overview',
            value: `**Total Cache Size:** ${totalCacheSize} items\n` +
        ...
        let cacheDetails = '';
        for (const [name, stats] of Object.entries(cacheStats)) {
            cacheDetails += `**${name}:** ${stats.size}/${stats.maxSize} items (${stats.hitRate})\n`;
        }
    ...
    async handleClear(embed) {
        ...
        embed.addFields({
            ...
            value: `**All caches have been cleared**\n` +
